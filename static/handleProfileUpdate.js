...
function CreateFormDateRangeField(
	startFieldName,
	startFieldID,
	fieldSize,
	required,
...
function CreateDateRangeFields(
	parent,
	startID,
	endID,
	presentID,
...
function EducationSection(parent, index) {
	...
	CreateTextFieldGroup(gridRow, "degree", "Major");
...
document.getElementById("AddPersonalTitle").addEventListener("click", () => {
	CreateFormTextField(
		...
		true,
		"Title",
		document.getElementById("titlesDropdown"),
	);
});
...
document.getElementById("AddCategorizedSkill").addEventListener("click", () => {
	...
	CategorizedSkillsSection(
		document.getElementById("categorizedSkillsDropdown"),
		categoryCpy,
	);
});

document
	.getElementById("AddUnclassifiedSkill")
	.addEventListener("click", () => {
		CreateFormTextField(
			...
			true,
			"Skill",
			document.getElementById("unclassifiedSkillsDropdown"),
		);
	});
...
document.getElementById("AddAccomplishment").addEventListener("click", () => {
	CreateFormTextField(
		...
		true,
		"Accomplishment",
		document.getElementById("accomplishmentsDropdown"),
	);
});
